...
void cli_motd() {
    printf("\r\n"
        ...
        "              :<script>.Ac816/        ,-._            sENbove3101.404:    \r\n"
        "              :NT_AUTHORITY.Do      _.-'  '--.        `T:/shSYSTEM-.N:    \r\n"
        "              :09.14.2011.raid    .'      _  -`\\_    /STFU|wall.No.Pr:    \r\n"
        "              :hevnsntSurb025N.  / .23--.`_.'----'   dNVRGOING2GIVUUP:    \r\n"
        "              :#OUTHOUSE-  -s:   ;/     `            /corykennedyData:    \r\n"
        "              :$nmap -oS        /_;                   SSo.6178306Ence:    \r\n"
        ...
        "                ▀▀▀ .▀▀▀ ▀▀▀.▀   .▀    ▀▀▀ .▀  ▀    ·▀▀▀ .▀▀▀ ▀▀▀         \r\n" 
           ...
           "SecKC Logo Source https://github.com/rapid7/metasploit-framework/blob/master/data/logos/haKCers.txt\r\n"
           "\r\n");
